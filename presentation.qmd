...
## What are your chances of winning a round, given the series state in COD SnD?
...
heatmap_div_labeller <- function(.df, .label, .num) {
  sprintf(
    '%+.1f\n(%s)', 
    100 * .df[[.label]], 
    scales::comma(.df$n)
...
## What are your chances of winning a round, given the series state in Valorant?
...
val_pre_swap_rounds <- filt_val_o_win_prop |> 
...
p_val_o_round_win_prop <- filt_val_o_win_prop |> 
  ggplot() +
